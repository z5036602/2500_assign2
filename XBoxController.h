...
namespace GamePad {
	...
	private:
		// Additional private data to keep track of controller state
		// Storing controller state
		XINPUT_STATE _controllerState;
		// Storing controller index
		DWORD _controllerId;
		// Storing deadzone coordinate for left and right thumb stick
		bool customDeadZone = false;
		unsigned int customDeadZoneRadius;
